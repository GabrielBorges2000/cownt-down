    ...
    <div className="min-h-screen bg-zinc-950 text-white flex flex-col justify-between p-8">
      ...
      <main className="flex-1 flex flex-col">
        <p className="text-zinc-400 mt-4">
          O Countdown é um aplicativo projetado para ajudar você a organizar seu tempo de forma
          eficiente. Com ele, é possível criar, personalizar e gerenciar contagens regressivas de
          maneira prática, seja para eventos importantes, metas pessoais ou prazos profissionais.
          Facilite sua rotina e nunca perca o controle dos seus momentos mais importantes!
        </p>
        <Separator className="my-8 bg-zinc-700" />
        ...
        <Card className="bg-zinc-950 border-zinc-700">
          <CardHeader>
            ...
            <CardDescription className="text-zinc-400">
              Precisa de ajuda? Entre em contato conosco através dos seguintes canais.
            </CardDescription>
          </CardHeader>
          <CardContent>
          ...
          <div className="py-12 grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="mt-4 text-sm text-gray-400">
                Compartilhando conhecimento e experiências no mundo do desenvolvimento.
              </p>
            </div>
            <div>
